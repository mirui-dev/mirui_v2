<div id="dashboard-nav-container" class="flex fill-width">
    ...
    <div id="dashboard-nav-menu" class="fill-width">
        <ul class="flex">
            ...
            <li id="dashboard-nav-menu-cart" wire:click="handler('cart')" class="flex  {{$cartClass}} ">MY CART<span id="dashboard-nav-menu-cart-number" class="dashboard--cart-number">{{$cartItem}}</span></li>
